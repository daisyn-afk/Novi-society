...
export default function MDProviderRelationships() {
  ...
  const other = relationships.filter((r) => r.status !== "active");
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs" style={{ color: "rgba(30,37,53,0.5)" }}>
                          {months} months supervised · {rel.provider_email}
                        </p>
                      </div>
                      <span
                      ...
                      <div className="px-4 pb-4 space-y-3 border-t" style={{ borderColor: "rgba(30,37,53,0.08)" }}>
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (window.confirm("Terminate this relationship?")) terminateMutation.mutate(rel.id);
                            }}
                          >
                            Terminate
                          </Button>
